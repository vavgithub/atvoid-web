  ...
  return (
    <>
      ...
      <section className="w-full mt-[100px] md:mt-[215px]">
        ...
        {diverseTeam.heading && (
          <div className="mb-4 px-5 md:px-10 lg:px-20">
            <div className="font-pp-neue-corp max-w-[300px] sm:max-w-[424px] md:max-w-[720px] mx-auto">
              ...
              <div className="mt-1 flex items-baseline gap-2">
                <div className="min-w-0">
                  {diverseTeam.heading.main1 && (
                    <h2 className="font-pp-neue-corp-wide text-[#F6F6F6] text-[20px] sm:text-[30px] md:text-[50px] lg:text-[60px] font-medium leading-[80%] tracking-[-1.2px] uppercase">
                      {diverseTeam.heading.main1}
                    </h2>
                  )}
                </div>
            ...
            <div className="relative w-full h-full min-h-[400px] md:min-h-[500px]">
              {diverseTeam.teamMembers.map((member, idx) => {
                ...
                return (
                  ...
                  >
                    {/* Name tag with background and arrow */}
                    <div 
                    ...
                    {/* Cursor/Arrow icon positioned at bottom-right of name tag */}
                    <svg 
